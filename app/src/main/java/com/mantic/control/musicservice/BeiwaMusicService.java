...
import com.mantic.control.api.beiwa.BwServiceApi;
...
public class BeiwaMusicService implements MyMusicService{
    private static final String TAG = "BeiwaMusicService";

    private final String SERVICEID = "beiwa";
    ...
    private void getCategoryList(){
        ...
        canRefresh = false;
        RequestBody body = MopidyTools.createRequestBrowse("beva:root");
