 ...
 */
public class MusicServiceSubItemLazyLoadFragment extends BaseSlideLazyLoadFragment implements IMusicServiceSubItemList,
        View.OnClickListener, DataFactory.MyChannelListListener {
    private static final String TAG = "MusicServiceSubItemLazyLoadFragment";
