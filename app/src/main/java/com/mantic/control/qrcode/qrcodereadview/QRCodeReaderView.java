...
public class QRCodeReaderView extends SurfaceView
  ...
  @Override public void surfaceCreated(SurfaceHolder holder) {
    ...
    try {
      ...
      Glog.w(TAG, "Can not openDriver: " + e.getMessage());
    ...
    try {
      ...
      Glog.e(TAG, "Exception: " + e.getMessage());
      mCameraManager.closeDriver();
    }
  }
  ...
  @Override public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
    ...
    if (holder.getSurface() == null) {
      Glog.e(TAG, "Error: preview surface does not exist");
      return;
    }

    if (mCameraManager.getPreviewSize() == null) {
      Glog.e(TAG, "Error: preview size does not exist");
      return;
    }
  ...
  private static class DecodeFrameTask extends AsyncTask<byte[], Void, Result> {
    ...
    @Override protected Result doInBackground(byte[]... params) {
      ...
      try {
        ...
        Glog.d(TAG, "ChecksumException", e);
      } catch (NotFoundException e) {
        Glog.d(TAG, "No QR Code found");
      } catch (FormatException e) {
        Glog.d(TAG, "FormatException", e);
      } finally {
