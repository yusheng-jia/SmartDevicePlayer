...
public class RadioMoreAdapter extends RecyclerView.Adapter<RadioMoreAdapter.ViewHolder> {
    ...
    public RadioMoreAdapter(Context mContext, Activity mActivity, ArrayList<MyChannel> myChannelList, String albumType) {
        super();
