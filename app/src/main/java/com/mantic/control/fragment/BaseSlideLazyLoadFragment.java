...
public abstract class BaseSlideLazyLoadFragment extends SwipeBackFragment implements
    ...
    private void onLazyLoad() {
        Glog.i(TAG, "mIsVisible = " + mIsVisible + " mIsFirst = " + mIsFirst + "  mIsPrepare = " + mIsPrepare);
        if (!mIsVisible || !mIsFirst || !mIsPrepare) {
            return;
        }
