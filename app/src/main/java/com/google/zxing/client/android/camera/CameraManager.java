...
public final class CameraManager {
  ...
  public synchronized void openDriver(SurfaceHolder holder, int width, int height)
    ...
    try {
      ...
      // Driver failed
      Glog.w(TAG, "Camera rejected parameters. Setting only minimal safe-mode parameters");
      Glog.i(TAG, "Resetting to saved camera params: " + parametersFlattened);
      // Reset:
      if (parametersFlattened != null) {
        ...
        try {
          ...
          // Well, darn. Give up
          Glog.w(TAG, "Camera rejected even safe-mode parameters! No configuration");
        }
      }
    }
