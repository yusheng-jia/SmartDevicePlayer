...
public class TunelnRadioMusicService implements MyMusicService{

    public static final String TAG = "TunelnRadioMusicService";
    ...
    public void getCategoryList(){
        ...
        RequestBody body = createRequestBrowse("tunein:root");
...
//    }
    ...
    public TunelnRadioMusicService() {
