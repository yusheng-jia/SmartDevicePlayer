...
public class SkillDetailFragment extends BaseSlideFragment implements View.OnClickListener {
    ...
    protected void initView(View view) {
        ...
        mWebview.addJavascriptInterface(new JSInterfaceSkillDetail(),"tonew");
