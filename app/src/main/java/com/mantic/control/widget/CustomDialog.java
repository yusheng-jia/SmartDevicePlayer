...
public class CustomDialog extends Dialog {
	...
	public static class Builder {
		...
		public final int BUTTON_NEGATIVE = 2;

		public interface DialogPositiveClickListener {
			void onPositiveClick(CustomDialog dialog);
		}
		public interface DialogNegativeClickListener {
			void onNegativeClick(CustomDialog dialog);
		}

		private DialogPositiveClickListener mDialogPositiveClickListener;
		private DialogNegativeClickListener mDialogNegativeClickListener;
		...
		public Builder setPositiveButton(int confirm_btnText,
			...
			this.mDialogPositiveClickListener = listener;
			return this;
		}
		...
		public Builder setNegativeButton(int cancel_btnText,
				DialogNegativeClickListener listener) {
			this.cancel_btnText = (String) context.getText(cancel_btnText);
			this.mDialogNegativeClickListener = listener;
			return this;
		}
		...
		public CustomDialog create() {
			...
			if (confirm_btnText != null) {
				((Button) layout.findViewById(R.id.confirm_btn))
						.setText(confirm_btnText);
				if (mDialogPositiveClickListener != null) {
					((Button) layout.findViewById(R.id.confirm_btn))
							.setOnClickListener(new View.OnClickListener() {
								public void onClick(View v) {
									mDialogPositiveClickListener.onPositiveClick(dialog);
								}
							});
				} else {
					((Button) layout.findViewById(R.id.confirm_btn))
			...
			if (cancel_btnText != null) {
				...
				if (mDialogNegativeClickListener != null) {
					((Button) layout.findViewById(R.id.cancel_btn))
							.setOnClickListener(new View.OnClickListener() {
								public void onClick(View v) {
									mDialogNegativeClickListener.onNegativeClick(dialog);
								}
							});
				} else {
					((Button) layout.findViewById(R.id.cancel_btn))
