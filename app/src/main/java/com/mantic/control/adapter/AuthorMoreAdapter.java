...
public class AuthorMoreAdapter extends RecyclerView.Adapter<AuthorMoreAdapter.ViewHolder> {
    ...
    public AuthorMoreAdapter(Context mContext, Activity mActivity, ArrayList<MyChannel> myChannelList, String authorType) {
        super();
