...
package com.mantic.control.qrcode.view;
...
import com.mantic.control.qrcode.utils.ScreenUtils;
...
public final class QrCodeFinderView extends RelativeLayout {
    ...
    public void onDraw(Canvas canvas) {
        ...
        drawTextOne(canvas, frame);
//        drawTextTwo(canvas, frame);
    ...
    private void drawTextOne(Canvas canvas, Rect rect) {
        int margin = 60;
        mPaint.setColor(mTextColor);
        mPaint.setTextSize(getResources().getDimension(R.dimen.music_device_list_item_text_name_size));
